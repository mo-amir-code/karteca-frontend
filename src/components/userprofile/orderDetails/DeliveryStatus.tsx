import { deliveryStatus } from '@/utils/services'
import React from 'react'

const DeliveryStatus = ({status}:{status:"pending" | "dispatched" | "shipped" | "delivered"}) => {
  return (
